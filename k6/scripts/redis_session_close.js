...
export default function () {
  ...
  const res_set = http.get('http://redis-http-session.example.com/session/set?data=XXXXX');
  ...
  group('Get Session Data', () => {
    const res_get = http.get('http://redis-http-session.example.com/session/get');
